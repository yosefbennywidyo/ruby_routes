...
RSpec.describe RubyRoutes::UrlHelpers do
  ...
  describe '.add_url_helper' do
    it 'defines a method that generates a path using the route' do
      ...
      instance = test_class.new(route_set)
      allow(route_set).to receive(:generate_path_from_route).and_return('/users/123')
